...
if Element(loc = '//*[@id="app"]/div/div/div/div/div[2]/div/div[2]/div[1]/div/div/div/div/div[1]/div[2]',l_type = 'XPATH').wait():
    ...
    #Element(loc = '//*[@id="cloud1"]/div',l_type = 'XPATH').click()
    #判断注册按钮出现
    if Element(loc = '//*[@id="app"]/div/div/div/div/div[2]/div/div[2]/div[3]/div[2]/div[2]/form/div[5]/div/div/span/a[2]',l_type = 'XPATH').wait():
        #开始计时
        starttime=time.time()
        #点击注册按钮 //*[@id="frloginform"]/div[3]/span/a[3]
        Element(loc = '//*[@id="app"]/div/div/div/div/div[2]/div/div[2]/div[3]/div[2]/div[2]/form/div[5]/div/div/span/a[2]',l_type = 'XPATH').click()
        if Element(loc = '//*[@id="app"]/div/div/div/div[2]/div[1]/div[1]/p/font',l_type = 'XPATH').wait():
            #获取检查点
            checkpoint = Element(loc = '//*[@id="app"]/div/div/div/div[2]/div[1]/div[1]/p/font',l_type = 'XPATH').value()
            #输出检查点
